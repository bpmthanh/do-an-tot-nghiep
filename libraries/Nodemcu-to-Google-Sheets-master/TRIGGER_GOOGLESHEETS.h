...
void Send_Data();
void Google_Sheets_Init(char array_2d[10][24], String sheets_gas_id, int param_size);
...
void Google_Sheets_Init(char test[ ][24], String sheets_gas_id, int param_size)
{
