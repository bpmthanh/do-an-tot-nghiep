...
<html>
   ...
   <body>
      <?php
         ...
         $sql = "UPDATE datadetail SET name='$newName', location='$newLocation' WHERE id = '$id'";
         ...
         $sql = "DELETE FROM datadetail WHERE id = '$id'";
         ...
         $sql = "SELECT id, name, location, time FROM datadetail ORDER BY id DESC";
         ...
         if ($result = $conn->query($sql)) {
             while ($row = $result->fetch_assoc()) {
                 ...
                 echo '<tr> 
                     ...
                     <td>
                         <div class = "action-buttons" id="action_buttons_' . $row_id . '">
